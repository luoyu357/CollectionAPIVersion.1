...
RDATools.add(entry(CollectionObject, RDA.Collection, {
    ...
    str(RDA.hasProvenance):{'label': 'provenance', 'type': lambda x: x, 'rdf': lambda x: URIRef(x+"#provenance"), 'map': {
        str(RDA.wasDerivedFrom): {'label': 'wasDerivedFrom', 'type': str, 'rdf': Literal, 'map': {}},
        str(RDA.wasRevisionOf): {'label': 'wasRevisionOf', 'type': str, 'rdf': Literal, 'map': {}},
        str(RDA.wasQuotedFrom): {'label': 'wasQuotedFrom', 'type': str, 'rdf': Literal, 'map': {}},
        str(RDA.hasPrimarySource): {'label': 'hasPrimarySource', 'type': str, 'rdf': Literal, 'map': {}},
        str(RDA.alternateOf): {'label': 'alternateOf', 'type': str, 'rdf': Literal, 'map': {}},
        str(RDA.specializationOf): {'label': 'specializationOf', 'type': str, 'rdf': Literal, 'map': {}},
    }}
}))
RDATools.add(entry(MemberItem, RDA.Member, {
    ...
    str(RDA.provenance):{'label': 'provenance', 'type': lambda x: x, 'rdf': lambda x: URIRef(x+"#provenance"), 'map': {
        str(RDA.wasDerivedFrom): {'label': 'wasDerivedFrom', 'type': str, 'rdf': Literal, 'map': {}},
        str(RDA.wasRevisionOf): {'label': 'wasRevisionOf', 'type': str, 'rdf': Literal, 'map': {}},
        str(RDA.wasQuotedFrom): {'label': 'wasQuotedFrom', 'type': str, 'rdf': Literal, 'map': {}},
        str(RDA.hasPrimarySource): {'label': 'hasPrimarySource', 'type': str, 'rdf': Literal, 'map': {}},
