...
class ModelError(Exception):
    ...
    def __init__(self, payload=None):
        ...
        self.message = "Invalid Input. The collection properties were malformed or invalid.(Model Error)"
...
class ParseError(Exception):
    ...
    def __init__(self, payload=None):
        Exception.__init__(self)
        self.message = "Invalid Input. The collection properties were malformed or invalid.(Parse Error)"
        self.status_code = 400
        self.payload = payload
