...
class MemberView(MethodView):
    ...
    def get(self, id, mid=None):
        try:
            if mid:
                self.output([mid],"member get start")
                #if profile:
                #    start = time.time()
            ...
            self.output([mid],"member get end")
    ...
    def post(self, id):
        try:
            ...
            self.output([o.id for o in obj], "member post start")
            ...
            self.output([o.id for o in obj], "member post end")
