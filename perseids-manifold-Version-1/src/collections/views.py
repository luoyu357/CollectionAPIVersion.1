...
class CollectionsView(MethodView):
    #print the information into collection.txt
    def output(self, id, operation):
        cwd = os.getcwd()
        file = open(cwd+"/collection.txt","a")
        line = str(id) + ", " + operation+ ", time : " + str(time.time())  + "\n"
        file.write(line)
        file.close()
    ...
    def get(self, id=None):
        ...
        try:
            ...
            if id:
                self.output([id],"collection get start")
            ...
            self.output([id],"collection get end")
    ...
    def post(self, id=None):
        try:
            ...
            self.output([obj.id for obj in objs], "collection post start")
            ...
            self.output([obj.id for obj in objs], "collection post end")
